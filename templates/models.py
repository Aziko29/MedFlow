...
# Doctor.specialty uchun ruxsat etilgan qiymatlar ro'yxati (Doctor
# yozuv/tahrirlash formasida <select> sifatida ko'rsatiladi — qarang:
# templates/base.html #d-specialty / #de-specialty). Bu erkin matn
# o'rniga izchil qiymatlarni kafolatlaydi: filtrlash (doctors.html
# qidiruvi) va hisobotlar (modules/reports.py, Doctor.specialty bo'yicha
# guruhlash) yozilish farqlaridan (masalan "LOR"/"Lor"/"lor") aziyat
# chekmasligi uchun. schemas.py shu yerdan import qiladi.
DOCTOR_SPECIALTIES = (
    "Terapevt",
    "Pediatr",
    "Kardiolog",
...
class GovIntegrationSettings(Base):
    ...
    # 🆕 "Ulanishni tekshirish" natijasi (modules/gov_integration.py'dagi
    # /test-connection). Haqiqiy so'rov PII yubormaydi — faqat server
    # javob berish-bermasligini tekshiradi va shu ikki maydonga yozadi.
