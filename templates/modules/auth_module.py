...
def login(
    ...
    if cached_user:
        ...
        # Cache'dan topildi - tez tekshirish. password_hash endi keshda
        # saqlanmaydi (xavfsizlik), shuning uchun yuqorida ID bo'yicha
        # bazadan olingan `user.password_hash` ishlatiladi.
